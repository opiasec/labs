INSERT INTO labs (id, slug, title, description, difficulty, estimated_time, authors, external_references, tags)
VALUES
  (gen_random_uuid(), 'example-lab', 'Example Lab', 'This is an example lab.', 'medium', 20, ARRAY['AppSec Digital'], ARRAY['https://labs.appsec.digital'], ARRAY['example', 'Node'])
...
INSERT INTO labs (
  ...
  gen_random_uuid(),
  'copy-n-paste-lab',
  'CopyNPaste API - SQL Injection Lab',
  'Um laboratório Golang que demonstra vulnerabilidades de SQL Injection através de uma API e front-end simples.',
  '# CopyNPaste API

<img src="https://raw.githubusercontent.com/globocom/secDevLabs/refs/heads/master/owasp-top10-2021-apps/a3/copy-n-paste/images/CopyNPaste.png" align="center"/>
...
<img src="https://raw.githubusercontent.com/globocom/secDevLabs/refs/heads/master/owasp-top10-2021-apps/a3/copy-n-paste/images/attack-0.png" align="center"/>
...
<img src="https://raw.githubusercontent.com/globocom/secDevLabs/refs/heads/master/owasp-top10-2021-apps/a3/copy-n-paste/images/attack-1.png" align="center"/>
...
<img src="https://raw.githubusercontent.com/globocom/secDevLabs/refs/heads/master/owasp-top10-2021-apps/a3/copy-n-paste/images/attack-2.png" align="center"/>

30 seconds later, thus confirming we can execute commands on the server:

<img src="https://raw.githubusercontent.com/globocom/secDevLabs/refs/heads/master/owasp-top10-2021-apps/a3/copy-n-paste/images/attack-3.png" align="center"/>

#### 🔥

An attacker could now create anymalicious SQL queries and send them to the API that, in theory, would be executed. For this attack narrative, [sqlmap](https://github.com/sqlmapproject/sqlmap) will be used to exemplify how an automated SQL Injection attack may be performed.
...
<img src="https://raw.githubusercontent.com/globocom/secDevLabs/refs/heads/master/owasp-top10-2021-apps/a3/copy-n-paste/images/attack-4.png" align="center"/>
...
<img src="https://raw.githubusercontent.com/globocom/secDevLabs/refs/heads/master/owasp-top10-2021-apps/a3/copy-n-paste/images/attack-5.png" align="center"/>
...
[app]: http://localhost:10001',
  ...
  45,
  true,
  ARRAY['sql-injection', 'golang', 'mysql', 'owasp-top10', 'a3-injection'],
  ARRAY['SecDevLabs Team']
);
